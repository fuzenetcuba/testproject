...
class DetailedGenerateDoctrineCrudCommand extends GenerateDoctrineCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setName('doctrine:detailed:generate:crud')
            ->setDescription('Generates a Detailed CRUD based on a Doctrine entity and form fields types')
            ->setHelp(<<<EOT
The <info>doctrine:detailed:generate:crud</info> command generates a CRUD based on a Doctrine entity.

The default command only generates the list and show actions.

<info>php app/console doctrine:detailed:generate:crud --entity=AcmeBlogBundle:Post --route-prefix=post_admin</info>

Using the --with-write option allows to generate the new, edit and delete actions.

<info>php app/console doctrine:detailed:generate:crud --entity=AcmeBlogBundle:Post --route-prefix=post_admin --with-write</info>
...
EOT
            ...
            ->setAliases(array('generate:detailed:doctrine:crud', 'generate:detailed:crud'));
    }
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $question = new ConfirmationQuestion($questionHelper->getQuestion('Do you want to generate the "write" actions', 'yes', '?', $withWrite), $withWrite);
    ...
    {
        return new DetailedDoctrineCrudGenerator(
    ...
    protected function getFormGenerator($bundle = null)
    {
        if (null === $this->formGenerator) {
            $this->formGenerator = new DetailedDoctrineFormGenerator($this->getContainer()->get('filesystem'));
    ...
    public function setFormGenerator(DetailedDoctrineFormGenerator $formGenerator)
    {
